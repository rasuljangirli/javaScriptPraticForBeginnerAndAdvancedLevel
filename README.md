...
### PROYEKTLƏR HAQQINDA MƏLUMAT:
  ...
  * ### Prime Number - filename: `primeNumber`
      ...
      Bu proyektdə **for loop** və **if else** istifadə edilərək daxil edilən rəqəmin (ədədin) sadə olub olmadığını yoxlayırıq.Ümumilikdə kodlar arasında da qeydlər yaz
